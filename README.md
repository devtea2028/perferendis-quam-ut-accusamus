...
[![Version](https://img.shields.io/npm/v/@devtea2028/perferendis-quam-ut-accusamus.svg)](https://npmjs.org/package/@devtea2028/perferendis-quam-ut-accusamus)
[![Downloads/week](https://img.shields.io/npm/dw/@devtea2028/perferendis-quam-ut-accusamus.svg)](https://npmjs.org/package/@devtea2028/perferendis-quam-ut-accusamus)
[![License](https://img.shields.io/npm/l/@devtea2028/perferendis-quam-ut-accusamus.svg)](https://github.com/devtea2028/perferendis-quam-ut-accusamus/blob/main/LICENSE)
...
- **Super Speed** - The overhead for running an oclif CLI command is almost nothing. [It requires very few dependencies](https://www.npmjs.com/package/@devtea2028/perferendis-quam-ut-accusamus?activeTab=dependencies) (only 28 dependencies in a minimal setup—including all transitive dependencies). Also, only the command to be executed will be required with node. So large CLIs with many commands will load equally as fast as a small one with a single command.
...
We strongly encourage you generate an oclif CLI using the [oclif cli](https://github.com/oclif/oclif). The generator will generate an npm package with `@devtea2028/perferendis-quam-ut-accusamus` as a dependency.

You can, however, use `@devtea2028/perferendis-quam-ut-accusamus` in a standalone script like this:

```typescript
#!/usr/bin/env -S node --loader ts-node/esm --no-warnings=ExperimentalWarning

import * as fs from 'fs'
import {Command, Flags, flush, handle} from '@devtea2028/perferendis-quam-ut-accusamus'
